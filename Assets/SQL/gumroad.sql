...
--INSERT INTO LogTable(LogTableID,LogTableName) VALUES(0,'')
--SET Identity_Insert LogTable OFF
--INSERT INTO LogTable(LogTableName) VALUES('Usr')
--INSERT INTO LogTable(LogTableName) VALUES('Act')
--INSERT INTO LogTable(LogTableName) VALUES('Question')
--INSERT INTO LogTable(LogTableName) VALUES('Answer')
--INSERT INTO LogTable(LogTableName) VALUES('Assignment')
--INSERT INTO LogTable(LogTableName) VALUES('Paper')
--INSERT INTO LogTable(LogTableName) VALUES('Guess')
--INSERT INTO LogTable(LogTableName) VALUES('Cat')
--INSERT INTO LogTable(LogTableName) VALUES('Course')
--INSERT INTO LogTable(LogTableName) VALUES('Scale')
GO
...
--INSERT INTO Person(PersonID,FirstName,LastName,UsrName,Email,PersonName,isSenior)
--SELECT PersonID,FirstName,LastName,UsrName,Email,PersonName,isSenior
--FROM LR2014Fall1..Person
...
--INSERT INTO Usr(UsrID,Usr_CourseID,Usr_PersonID,GloballyUniqueIdentifier,isAdmin)
--SELECT UsrID,Usr_CourseID,Usr_PersonID,GloballyUniqueIdentifier,isAdmin
--FROM LR2014Fall1..Usr
...
exec AddAssignment @ActID,@CatSort,@AssignmentStart,@AssignmentStop,1
GO
...
INSERT INTO Person(FirstName,LastName,PersonName,Email) VALUES('Phillip','Senn','Phillip Senn','Phillip.Senn@my.lr.edu')
SELECT @PersonID = SCOPE_IDENTITY()

set identity_insert Term ON
INSERT INTO Term(TermID,TermName,TermStart,LastDayOfClasses,FinalStart,FinalStop,GradesDueGrad,FinalGradesDue) VALUES(
 20141016
...
set identity_insert Course ON
INSERT INTO Course(CourseID,CourseName,Course_TermID,CourseSort,CourseDesc) VALUES(1,'CSC115',@TermID,1,'gumroad')
...
INSERT INTO Scale(Scale_CourseID,Scale_CatID,ScaleSort) VALUES(@CourseID,@CatID,10)
INSERT INTO Usr(UsrName,GloballyUniqueIdentifier,Usr_CourseID,Usr_PersonID,isAdmin) VALUES('Professor Senn','5AA651D6-9D81-4CE5-B041-3797A31B8569',@CourseID,@PersonID,1)

INSERT INTO Person(LastName,FirstName,PersonName,Email) VALUES('Wimmer','Joe','Joe Wimmer','joewimmer@gmail.com')
INSERT INTO Usr(Usr_CourseID,Usr_PersonID) VALUES(@CourseID,Scope_Identity())

INSERT INTO Person(LastName,FirstName,PersonName,Email) VALUES('Vincent','Seth','Seth Vincent','seth@superbigtree.com')
INSERT INTO Usr(Usr_CourseID,Usr_PersonID) VALUES(@CourseID,Scope_Identity())
	


update Usr set UsrName=(
	SELECT PersonName
	FROM Person
	WHERE PersonID=Usr_PersonID
)
FROM Usr
WHERE isAdmin=0
